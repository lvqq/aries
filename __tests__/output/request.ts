 ...
 */
export const postPetPetIdUploadImage = (args: { path: PostPetPetIdUploadImageRequestPath }) =>
  axios.post(`/v2/pet/${args.path.petId}/uploadImage`, {});

/**
 * @summary Add a new pet to the store
 */
export const postPet = (args: { data: PostPetRequestBody }) =>
  axios.post('/v2/pet', {
    data: args.data,
  });
 ...
 */
export const putPet = (args: { data: PutPetRequestBody }) =>
  axios.put('/v2/pet', {
    data: args.data,
  });
 ...
 */
export const getPetFindByStatus = (args: { params: GetPetFindByStatusRequestQuery }) =>
 ...
 */
export const getPetFindByTags = (args: { params: GetPetFindByTagsRequestQuery }) =>
 ...
 */
export const getPetPetId = (args: { path: GetPetPetIdRequestPath }) =>
  axios.get(`/v2/pet/${args.path.petId}`, {});

/**
 * @summary Updates a pet in the store with form data
 */
export const postPetPetId = (args: { path: PostPetPetIdRequestPath }) =>
  axios.post(`/v2/pet/${args.path.petId}`, {});

/**
 * @summary Deletes a pet
 */
export const deletePetPetId = (args: { path: DeletePetPetIdRequestPath }) =>
  axios.delete(`/v2/pet/${args.path.petId}`, {});

/**
 * @summary Place an order for a pet
 */
export const postStoreOrder = (args: { data: PostStoreOrderRequestBody }) =>
 ...
 */
export const getStoreOrderOrderId = (args: { path: GetStoreOrderOrderIdRequestPath }) =>
 ...
 */
export const deleteStoreOrderOrderId = (args: { path: DeleteStoreOrderOrderIdRequestPath }) =>
 ...
 */
export const postUserCreateWithArray = (args: { data: PostUserCreateWithArrayRequestBody }) =>
 ...
 * @summary Creates list of users with given input array
 */
export const postUserCreateWithList = (args: { data: PostUserCreateWithListRequestBody }) =>
 ...
 */
export const getUserUsername = (args: { path: GetUserUsernameRequestPath }) =>
 ...
 * @description This can only be done by the logged in user.
 */
export const deleteUserUsername = (args: { path: DeleteUserUsernameRequestPath }) =>
  axios.delete(`/v2/user/${args.path.username}`, {});

/**
 * @summary Logs user into the system
 */
export const getUserLogin = (args: { params: GetUserLoginRequestQuery }) =>
 ...
 * @description This can only be done by the logged in user.
 */
export const postUser = (args: { data: PostUserRequestBody }) =>
  axios.post('/v2/user', {
    data: args.data,
  });
